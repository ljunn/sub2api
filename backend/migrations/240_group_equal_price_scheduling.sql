-- Existing and new groups reject equal purchase prices unless explicitly enabled.
ALTER TABLE groups ADD COLUMN IF NOT EXISTS allow_equal_price_scheduling BOOLEAN NOT NULL DEFAULT FALSE;

-- Preserve existing invalidation fields and include the new scheduling option.
...
BEGIN
    ...
    IF TG_OP = 'UPDATE'
       ...
       AND OLD.allow_equal_price_scheduling IS NOT DISTINCT FROM NEW.allow_equal_price_scheduling
