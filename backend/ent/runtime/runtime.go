...
func init() {
	...
	// groupDescAllowEqualPriceScheduling is the schema descriptor for allow_equal_price_scheduling field.
	groupDescAllowEqualPriceScheduling := groupFields[60].Descriptor()
	// group.DefaultAllowEqualPriceScheduling holds the default value on creation for the allow_equal_price_scheduling field.
	group.DefaultAllowEqualPriceScheduling = groupDescAllowEqualPriceScheduling.Default.(bool)
