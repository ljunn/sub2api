...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamSiteRepository := repository.NewUpstreamSiteRepository(db)
	...
	upstreamSiteService := service.ProvideUpstreamSiteService(upstreamSiteRepository, accountRepository, adminService, upstreamSiteSecretEncryptor, upstreamSitePricing, settingRepository, notificationEmailService, userRepository, redisClient)
	...
	accountHandler := admin.ProvideAccountHandler(configConfig, adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService, upstreamSitePricing)
