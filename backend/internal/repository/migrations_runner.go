...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// The host previously applied a fork's OpenCode migration and platform-superset
	// repair. Its four constraints already include every upstream platform, plus
	// Kiro/Adobe where supported. Preserve those constraints and the original ledger;
	// only this audited pair is compatible, not arbitrary changes to migration 238.
	"238_opencode_go_platform.sql": newMigrationChecksumCompatibilityRule("6f987e251519bd3759e60da44620a5d777494cceb333b6ce394aa0ea536ef5a2", "d310f134e119bd0b01c36e048841d04e1adc04a117c5c516ccdbbc8800742414"),
}
