...
func TestWuzuPriceGateProtectsOutputOverridesAndLocalBilling(t *testing.T) {
	for _, tc := range []struct {
		...
		{`{"size":"1024x1024","output_width":4096}`, "1K", true},
		{`{"size":"1024x1024","__output_width":4096,"output_height":4096}`, "1K", true},
		{`{"size":"1024x1024","width":999999,"height":999999}`, "1K", true},
