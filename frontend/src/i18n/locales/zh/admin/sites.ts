export default {
  sites: {
    ...
    manualPrice: {
      ...
      "image": "按图片（USD / 张）",
      "video": "按视频时长（USD / 秒）",
      "videoRequest": "按视频次数（USD / 次）",
      "videoRequestPrice": "每次视频采购价（USD）",
      "videoResolutionPrice": "{resolution}（USD / 秒）",
      "videoImagePriceInvalid": "这是视频模型，原先保存的图片采购价不适用。请重新填写视频价格，或恢复自动价格。",
